  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto my-2 my-lg-0">
       ...
       <li class="nav-item">
          <a class="nav-link active" href="/Food_Master/Admin/AddItems.jsp">Add Item</a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/Food_Master/update.jsp">Update Status</a>
        </li>
        </ul>
     </div>
  </div>
      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
			<%@include file="/alerts/items.jsp" %>
            <div class="mb-md-5 mt-md-4 pb-5">
			<form action="/Food_Master/AddItem">
              <h2 class="fw-bold mb-2 text-uppercase">Add Items</h2>
              <br>
			<div class="form-outline form-white mb-4">
              ...
              <div class="form-outline form-white mb-4">
                ...
                <input type="text" name="cuisine" class="form-control form-control-lg" />
              </div>
