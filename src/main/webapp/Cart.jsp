...
<%try {
	...
	statement = connection.createStatement();
	 ...
	 QueryString = "SELECT * FROM cart where uname='"+uname+"'and cuisine='"+cui+"'";
  	}
  	else{
  		
  	
  		QueryString = "SELECT * FROM cart where uname='"+uname+"'";
  	}
...
<form action="Cart"><button class="btn btn-light" name="cuisine"  onclick="submit">All</button></form>
<form action="Cart.jsp"><button class="btn btn-light" name="cuisine" value=<%=i%> onclick="submit">Indian</button></form>
<form action="Cart.jsp"><button class="btn btn-light" name="cuisine" value=<%=c%> onclick="submit">Chinese</button></form>
</div>
<table class="center">
